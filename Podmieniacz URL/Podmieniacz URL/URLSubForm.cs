...
{
    public partial class URLSubFrom : Form
    {
        public string text;
        public URLSubFrom()
        {
        ...
        private void buttonSubURLs_Click(object sender, EventArgs e)
        {
            text = URLSubber.SubURLs(text);
            richTextBoxCode.Text = text;
            SetErrorMessage("Substitution successful!");
        }
